...
minetest.register_craftitem("smartshop:currency_1", {
	stack_max = 10000,
	inventory_image = "[combine:16x16^[noalpha^[colorize:#222:255",
})
...
minetest.register_craftitem(
	"smartshop:currency_100",
	{ inventory_image = "[combine:16x16^[noalpha^[colorize:#EEE:255" }
)
minetest.register_craftitem("smartshop:currency_10000", {
	stack_max = 10000,
	inventory_image = "[combine:16x16^[noalpha^[colorize:#0F0:255",
})
