	...
	loot = {
		["mcl_barrels:barrel_closed"] ={{
			...
			items = {
				...
				{ itemstring = "mcl_armor:chestplate_leather", weight = 10, amount_max = 1},
				{ itemstring = "mcl_armor:leggings_leather", weight = 10, amount_max = 1},
				{ itemstring = "mcl_core:gold_ingot", weight = 8, amount_min = 2, amount_max = 7 },
				{ itemstring = "mcl_armor:helmet_leather", weight = 6, amount_max = 1},
				{ itemstring = "mcl_armor:boots_leather", weight = 6, amount_max = 1},
				{ itemstring = "mcl_armor:leggings_iron", weight = 5 },
				{ itemstring = "mcl_tools:pick_diamond", weight = 5, amount_max = 1},
				{ itemstring = "mcl_core:diamond", weight = 5, amount_max = 2 },
				{ itemstring = "mcl_tools:sword_diamond", weight = 2, amount_max = 1},
				{ itemstring = "mcl_armor:chestplate_diamond", weight = 1 , amount_max=1},
			}
		}}
	},
